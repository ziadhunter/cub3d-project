...
typedef struct s_element
{
	char						*type;
	int							length;
	void						(*handle)(t_map_data *map, char **str,
			char **lines, int i);
}								t_element;
...
/* PARSING FUNCTIONS */
void							add_ceiling(t_map_data *map, char **str,
									char **lines, int i);
void							add_we(t_map_data *map, char **str,
									char **lines, int i);
void							add_ea(t_map_data *map, char **str,
									char **lines, int i);
void							add_so(t_map_data *map, char **str,
									char **lines, int i);
void							add_no(t_map_data *map, char **str,
									char **lines, int i);
void							add_floor(t_map_data *map, char **str,
									char **lines, int i);
void							which_element(char **line, int index,
									t_map_data *map, t_element element[6]);
...
void							find_empty_line(t_map_data *map_info,
									char **lines, char *line, int fd);
void							check_empty_line(t_map_data *map_info,
									char **lines, char *file_name);
char							**set_new_lines(int len, int characters,
									char **lines);
char							**rebuild_map_with_same_size(t_map_data *map,
									char **lines, int start);
t_data							*parsing_the_map(t_map_data *map_info,
									char **lines, char *file_name);
...
void							check_element_position(t_map_data *map_info,
									t_player **player, char **lines,
									t_cord cor);
void							check_space_position(t_map_data *map_info,
									t_player *player, char **lines, t_cord cor);
t_player						*valid_map(t_map_data *map_info, char **map,
									int i, int j);
