...
/*   Updated: 2025/12/10 18:24:13 by zfarouk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	put_image_to_new_window(&data->new_image, &data->player->gun->gun_show, data->player->gun->gs_i * WIN_WIDTH);
...
{
	put_image_to_new_window(&data->new_image, &data->player->gun->gun_fire, data->player->gun->gf_i * WIN_WIDTH);
...
{
	put_image_to_new_window(&data->new_image, &data->player->gun->gun_reload, data->player->gun->gr_i * WIN_WIDTH);
...
{
	put_image_to_new_window(&data->new_image, &data->player->gun->gun_move, data->player->gun->gm_i * WIN_WIDTH);
